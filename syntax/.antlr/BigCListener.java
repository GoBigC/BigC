...
public interface BigCListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link BigCParser#increaseDecrease}.
	 * @param ctx the parse tree
	 */
	void enterIncreaseDecrease(BigCParser.IncreaseDecreaseContext ctx);
	/**
	 * Exit a parse tree produced by {@link BigCParser#increaseDecrease}.
	 * @param ctx the parse tree
	 */
	void exitIncreaseDecrease(BigCParser.IncreaseDecreaseContext ctx);
	/**
