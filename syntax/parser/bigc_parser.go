...
func bigcParserInit() {
	...
	staticData.serializedATN = []int32{
		...
		27, 28, 1, 0, 29, 30, 2, 0, 28, 28, 31, 31, 1, 0, 33, 36, 285, 0, 89, 1,
		0, 0, 0, 2, 94, 1, 0, 0, 0, 4, 101, 1, 0, 0, 0, 6, 105, 1, 0, 0, 0, 8,
		117, 1, 0, 0, 0, 10, 119, 1, 0, 0, 0, 12, 127, 1, 0, 0, 0, 14, 132, 1,
		0, 0, 0, 16, 143, 1, 0, 0, 0, 18, 147, 1, 0, 0, 0, 20, 149, 1, 0, 0, 0,
		22, 157, 1, 0, 0, 0, 24, 167, 1, 0, 0, 0, 26, 169, 1, 0, 0, 0, 28, 175,
		1, 0, 0, 0, 30, 179, 1, 0, 0, 0, 32, 181, 1, 0, 0, 0, 34, 185, 1, 0, 0,
		0, 36, 188, 1, 0, 0, 0, 38, 191, 1, 0, 0, 0, 40, 198, 1, 0, 0, 0, 42, 201,
		1, 0, 0, 0, 44, 208, 1, 0, 0, 0, 46, 211, 1, 0, 0, 0, 48, 218, 1, 0, 0,
		0, 50, 221, 1, 0, 0, 0, 52, 223, 1, 0, 0, 0, 54, 230, 1, 0, 0, 0, 56, 233,
		1, 0, 0, 0, 58, 235, 1, 0, 0, 0, 60, 242, 1, 0, 0, 0, 62, 245, 1, 0, 0,
		0, 64, 247, 1, 0, 0, 0, 66, 254, 1, 0, 0, 0, 68, 257, 1, 0, 0, 0, 70, 263,
		1, 0, 0, 0, 72, 265, 1, 0, 0, 0, 74, 267, 1, 0, 0, 0, 76, 272, 1, 0, 0,
		0, 78, 276, 1, 0, 0, 0, 80, 282, 1, 0, 0, 0, 82, 296, 1, 0, 0, 0, 84, 298,
		1, 0, 0, 0, 86, 88, 3, 2, 1, 0, 87, 86, 1, 0, 0, 0, 88, 91, 1, 0, 0, 0,
		89, 87, 1, 0, 0, 0, 89, 90, 1, 0, 0, 0, 90, 92, 1, 0, 0, 0, 91, 89, 1,
		0, 0, 0, 92, 93, 5, 0, 0, 1, 93, 1, 1, 0, 0, 0, 94, 95, 3, 6, 3, 0, 95,
		97, 5, 32, 0, 0, 96, 98, 3, 4, 2, 0, 97, 96, 1, 0, 0, 0, 97, 98, 1, 0,
		0, 0, 98, 99, 1, 0, 0, 0, 99, 100, 3, 8, 4, 0, 100, 3, 1, 0, 0, 0, 101,
		102, 5, 1, 0, 0, 102, 103, 3, 30, 15, 0, 103, 104, 5, 2, 0, 0, 104, 5,
		1, 0, 0, 0, 105, 106, 7, 0, 0, 0, 106, 7, 1, 0, 0, 0, 107, 109, 5, 8, 0,
		0, 108, 110, 3, 10, 5, 0, 109, 108, 1, 0, 0, 0, 109, 110, 1, 0, 0, 0, 110,
		111, 1, 0, 0, 0, 111, 112, 5, 9, 0, 0, 112, 118, 3, 14, 7, 0, 113, 115,
		3, 36, 18, 0, 114, 113, 1, 0, 0, 0, 114, 115, 1, 0, 0, 0, 115, 116, 1,
		0, 0, 0, 116, 118, 5, 10, 0, 0, 117, 107, 1, 0, 0, 0, 117, 114, 1, 0, 0,
		0, 118, 9, 1, 0, 0, 0, 119, 124, 3, 12, 6, 0, 120, 121, 5, 11, 0, 0, 121,
		123, 3, 12, 6, 0, 122, 120, 1, 0, 0, 0, 123, 126, 1, 0, 0, 0, 124, 122,
		1, 0, 0, 0, 124, 125, 1, 0, 0, 0, 125, 11, 1, 0, 0, 0, 126, 124, 1, 0,
		0, 0, 127, 128, 3, 6, 3, 0, 128, 130, 5, 32, 0, 0, 129, 131, 3, 4, 2, 0,
		130, 129, 1, 0, 0, 0, 130, 131, 1, 0, 0, 0, 131, 13, 1, 0, 0, 0, 132, 136,
		5, 12, 0, 0, 133, 135, 3, 16, 8, 0, 134, 133, 1, 0, 0, 0, 135, 138, 1,
		0, 0, 0, 136, 134, 1, 0, 0, 0, 136, 137, 1, 0, 0, 0, 137, 139, 1, 0, 0,
		0, 138, 136, 1, 0, 0, 0, 139, 140, 5, 13, 0, 0, 140, 15, 1, 0, 0, 0, 141,
		144, 3, 2, 1, 0, 142, 144, 3, 18, 9, 0, 143, 141, 1, 0, 0, 0, 143, 142,
		1, 0, 0, 0, 144, 17, 1, 0, 0, 0, 145, 148, 3, 20, 10, 0, 146, 148, 3, 24,
		12, 0, 147, 145, 1, 0, 0, 0, 147, 146, 1, 0, 0, 0, 148, 19, 1, 0, 0, 0,
		149, 150, 5, 14, 0, 0, 150, 151, 5, 8, 0, 0, 151, 152, 3, 30, 15, 0, 152,
		153, 5, 9, 0, 0, 153, 155, 3, 14, 7, 0, 154, 156, 3, 22, 11, 0, 155, 154,
		1, 0, 0, 0, 155, 156, 1, 0, 0, 0, 156, 21, 1, 0, 0, 0, 157, 160, 5, 15,
		0, 0, 158, 161, 3, 14, 7, 0, 159, 161, 3, 20, 10, 0, 160, 158, 1, 0, 0,
		0, 160, 159, 1, 0, 0, 0, 161, 23, 1, 0, 0, 0, 162, 163, 3, 30, 15, 0, 163,
		164, 5, 10, 0, 0, 164, 168, 1, 0, 0, 0, 165, 168, 3, 26, 13, 0, 166, 168,
		3, 28, 14, 0, 167, 162, 1, 0, 0, 0, 167, 165, 1, 0, 0, 0, 167, 166, 1,
		0, 0, 0, 168, 25, 1, 0, 0, 0, 169, 170, 5, 16, 0, 0, 170, 171, 5, 8, 0,
		0, 171, 172, 3, 30, 15, 0, 172, 173, 5, 9, 0, 0, 173, 174, 3, 14, 7, 0,
		174, 27, 1, 0, 0, 0, 175, 176, 5, 17, 0, 0, 176, 177, 3, 30, 15, 0, 177,
		178, 5, 10, 0, 0, 178, 29, 1, 0, 0, 0, 179, 180, 3, 32, 16, 0, 180, 31,
		1, 0, 0, 0, 181, 183, 3, 38, 19, 0, 182, 184, 3, 34, 17, 0, 183, 182, 1,
		0, 0, 0, 183, 184, 1, 0, 0, 0, 184, 33, 1, 0, 0, 0, 185, 186, 5, 18, 0,
		0, 186, 187, 3, 32, 16, 0, 187, 35, 1, 0, 0, 0, 188, 189, 5, 18, 0, 0,
		189, 190, 3, 30, 15, 0, 190, 37, 1, 0, 0, 0, 191, 195, 3, 42, 21, 0, 192,
		194, 3, 40, 20, 0, 193, 192, 1, 0, 0, 0, 194, 197, 1, 0, 0, 0, 195, 193,
		1, 0, 0, 0, 195, 196, 1, 0, 0, 0, 196, 39, 1, 0, 0, 0, 197, 195, 1, 0,
		0, 0, 198, 199, 5, 19, 0, 0, 199, 200, 3, 42, 21, 0, 200, 41, 1, 0, 0,
		0, 201, 205, 3, 46, 23, 0, 202, 204, 3, 44, 22, 0, 203, 202, 1, 0, 0, 0,
		204, 207, 1, 0, 0, 0, 205, 203, 1, 0, 0, 0, 205, 206, 1, 0, 0, 0, 206,
		43, 1, 0, 0, 0, 207, 205, 1, 0, 0, 0, 208, 209, 5, 20, 0, 0, 209, 210,
		3, 46, 23, 0, 210, 45, 1, 0, 0, 0, 211, 215, 3, 52, 26, 0, 212, 214, 3,
		48, 24, 0, 213, 212, 1, 0, 0, 0, 214, 217, 1, 0, 0, 0, 215, 213, 1, 0,
		0, 0, 215, 216, 1, 0, 0, 0, 216, 47, 1, 0, 0, 0, 217, 215, 1, 0, 0, 0,
		218, 219, 3, 50, 25, 0, 219, 220, 3, 52, 26, 0, 220, 49, 1, 0, 0, 0, 221,
		222, 7, 1, 0, 0, 222, 51, 1, 0, 0, 0, 223, 227, 3, 58, 29, 0, 224, 226,
		3, 54, 27, 0, 225, 224, 1, 0, 0, 0, 226, 229, 1, 0, 0, 0, 227, 225, 1,
		0, 0, 0, 227, 228, 1, 0, 0, 0, 228, 53, 1, 0, 0, 0, 229, 227, 1, 0, 0,
		0, 230, 231, 3, 56, 28, 0, 231, 232, 3, 58, 29, 0, 232, 55, 1, 0, 0, 0,
		233, 234, 7, 2, 0, 0, 234, 57, 1, 0, 0, 0, 235, 239, 3, 64, 32, 0, 236,
		...
		1, 0, 0, 0, 288, 81, 1, 0, 0, 0, 289, 287, 1, 0, 0, 0, 290, 297, 5, 32,
...
func (p *BigCParser) BlockItem() (localctx IBlockItemContext) {
	...
	case BigCParserT__7, BigCParserT__13, BigCParserT__15, BigCParserT__16, BigCParserT__27, BigCParserT__30, BigCParserIdentifier, BigCParserIntegerConstant, BigCParserFloatingConstant, BigCParserBooleanConstant, BigCParserCharConstant:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(142)
			p.Statement()
...
func (p *BigCParser) Statement() (localctx IStatementContext) {
	...
	case BigCParserT__7, BigCParserT__15, BigCParserT__16, BigCParserT__27, BigCParserT__30, BigCParserIdentifier, BigCParserIntegerConstant, BigCParserFloatingConstant, BigCParserBooleanConstant, BigCParserCharConstant:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(146)
			p.NonIfStatement()
...
func (p *BigCParser) NonIfStatement() (localctx INonIfStatementContext) {
	...
	switch p.GetTokenStream().LA(1) {
	case BigCParserT__7, BigCParserT__27, BigCParserT__30, BigCParserIdentifier, BigCParserIntegerConstant, BigCParserFloatingConstant, BigCParserBooleanConstant, BigCParserCharConstant:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(162)
			p.Expression()
